...
export function Timeline() {
  ...
  return (
    <div style={{ fontFamily: "'Tajawal', sans-serif" }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '320px minmax(0, 1fr)', gap: 22, alignItems: 'start' }}>
        {/* SIDEBAR */}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 22, minWidth: 0 }}>
          <div style={{ background: 'var(--paper-2)', border: '1px solid var(--line)', borderRadius: 16, padding: 18, boxShadow: 'var(--shadow)', minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
              <button onClick={() => move(-1)} style={{ width: 40, height: 40, borderRadius: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid var(--line)', background: 'var(--paper)', cursor: 'pointer', flexShrink: 0 }}>
                <CaretRight size={20} />
              </button>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: 'var(--slate)', fontWeight: 700, whiteSpace: 'nowrap' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18, overflowX: 'auto', paddingBottom: 6 }}>
